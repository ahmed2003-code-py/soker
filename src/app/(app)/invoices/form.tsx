      ...
      {سيُحفظ_غير_مسعّر && (
        <div className="rounded-xl border border-amber-300 bg-amber-50 p-4">
          <p className="text-[13px] leading-6 text-amber-900">
            <span className="font-semibold">فاتورة غير مسعّرة —</span> فيه صنف واحد على الأقل من غير سعر، فهتتحفظ على حساب العميل
            بالأصناف والكميات والأوزان <span className="font-semibold">بدون أي أثر مالي</span> ولا يمكن تحصيل دفعة.
